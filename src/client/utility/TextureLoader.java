...
public class TextureLoader {
     ...
     * @throws IOException Indicates a failure to access the resource
     */
    public client.utility.Texture getTexture(String resourceName, 
                              int target, 
                              int dstPixelFormat, 
                              int minFilter, 
    ...
    { 
        ...
        client.utility.Texture texture = new client.utility.Texture(target,textureID); 
     ...
     */
    private ByteBuffer convertImageData(BufferedImage bufferedImage, client.utility.Texture texture) { 
